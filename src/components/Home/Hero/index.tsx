  ...
  return (
    <section>
      ...
      <div className="text-center px-5 w-full ">
        <h1 className="text-[50px] text-[#B7B7B7] font-extrabold ">
          You{""}
          <span className="text-[60px] text-[#09D1D5] font-extrabold">
            think{" "}
          </span>
          <span className="text-[60px] text-[#09D1D5] font-extrabold">
            big{""}
        ...
        {/* <h1 className="text-[60px] text-[#09D1D5] font-extrabold">think</h1> */}
      </div>
    </section>
